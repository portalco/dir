...
const (
	VersionService_GetVersion_FullMethodName = "/saas.v1alpha1.VersionService/GetVersion"
)
...
//
// Version service for getting the current and supported version of the service
...
var VersionService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "saas.v1alpha1.VersionService",
	...
	Metadata: "saas/v1alpha1/version.proto",
}
